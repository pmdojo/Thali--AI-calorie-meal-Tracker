    ...
    <Svg width={size} height={size} viewBox="0 0 48 48">
      ...
      {kind === 'breakfast' && (
        <>
          ...
          <Ellipse cx="24" cy="25" rx="15" ry="3.4" fill="#DCEAFB" />
          <Path d="M19 13 q3.5 -3.5 0 -7" stroke="#6EA8FF" strokeWidth="2.2" fill="none" strokeLinecap="round" />
          <Path d="M28 13 q3.5 -3.5 0 -7" stroke="#6EA8FF" strokeWidth="2.2" fill="none" strokeLinecap="round" />
        </>
      )}
      ...
      {kind === 'lunch' && (
        <>
          ...
          <Path d="M24 10 V38" stroke="#DCEAFB" strokeWidth="2" strokeLinecap="round" />
          <Path d="M24 20 L31 15 M24 27 L17 22" stroke="#DCEAFB" strokeWidth="1.6" strokeLinecap="round" />
        </>
      )}
      ...
      {kind === 'dinner' && (
        <>
          ...
          <Circle cx="24" cy="24" r="9.5" fill="#DCEAFB" />
      ...
      {kind === 'snack' && (
        <>
          ...
          <Circle cx="20" cy="22" r="1.8" fill="#DCEAFB" />
          <Circle cx="28" cy="26" r="1.8" fill="#DCEAFB" />
          <Circle cx="24" cy="18" r="1.8" fill="#DCEAFB" />
          <Circle cx="27" cy="20" r="1.4" fill="#DCEAFB" />
        </>
      )}
    </Svg>
  );
